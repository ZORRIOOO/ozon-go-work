...
//go:generate minimock -i homework/cart/internal/pkg/cart/service/add-item.LomsService -o loms_service_mock.go -n LomsServiceMock -p mock
...
// LomsServiceMock implements mm_add_item.LomsService
type LomsServiceMock struct {
	t          minimock.Tester
	finishOnce sync.Once

	funcCreateOrder          func(request lomsTypes.OrderCreateRequest) (op1 *lomsTypes.OrderCreateResponse, err error)
	funcCreateOrderOrigin    string
	inspectFuncCreateOrder   func(request lomsTypes.OrderCreateRequest)
	afterCreateOrderCounter  uint64
	beforeCreateOrderCounter uint64
	CreateOrderMock          mLomsServiceMockCreateOrder

	funcStocksInfo          func(request lomsTypes.StocksInfoRequest) (sp1 *lomsTypes.StocksInfoResponse, err error)
	funcStocksInfoOrigin    string
	inspectFuncStocksInfo   func(request lomsTypes.StocksInfoRequest)
	afterStocksInfoCounter  uint64
	beforeStocksInfoCounter uint64
	StocksInfoMock          mLomsServiceMockStocksInfo
}

// NewLomsServiceMock returns a mock for mm_add_item.LomsService
...
type LomsServiceMockCreateOrderParams struct {
	request lomsTypes.OrderCreateRequest
}
...
type LomsServiceMockCreateOrderResults struct {
	op1 *lomsTypes.OrderCreateResponse
	err error
}
...
func (mmCreateOrder *mLomsServiceMockCreateOrder) Expect(request lomsTypes.OrderCreateRequest) *mLomsServiceMockCreateOrder {
...
func (mmCreateOrder *mLomsServiceMockCreateOrder) ExpectRequestParam1(request lomsTypes.OrderCreateRequest) *mLomsServiceMockCreateOrder {
	if mmCreateOrder.mock.funcCreateOrder != nil {
		mmCreateOrder.mock.t.Fatalf("LomsServiceMock.CreateOrder mock is already set by Set")
	}
...
func (mmCreateOrder *mLomsServiceMockCreateOrder) Inspect(f func(request lomsTypes.OrderCreateRequest)) *mLomsServiceMockCreateOrder {
...
func (mmCreateOrder *mLomsServiceMockCreateOrder) Return(op1 *lomsTypes.OrderCreateResponse, err error) *LomsServiceMock {
	if mmCreateOrder.mock.funcCreateOrder != nil {
		mmCreateOrder.mock.t.Fatalf("LomsServiceMock.CreateOrder mock is already set by Set")
	}
...
func (mmCreateOrder *mLomsServiceMockCreateOrder) Set(f func(request lomsTypes.OrderCreateRequest) (op1 *lomsTypes.OrderCreateResponse, err error)) *LomsServiceMock {
	if mmCreateOrder.defaultExpectation != nil {
...
// Then helper
func (mmCreateOrder *mLomsServiceMockCreateOrder) When(request lomsTypes.OrderCreateRequest) *LomsServiceMockCreateOrderExpectation {
	if mmCreateOrder.mock.funcCreateOrder != nil {
		mmCreateOrder.mock.t.Fatalf("LomsServiceMock.CreateOrder mock is already set by Set")
	}
...
func (e *LomsServiceMockCreateOrderExpectation) Then(op1 *lomsTypes.OrderCreateResponse, err error) *LomsServiceMock {
...
// CreateOrder implements mm_add_item.LomsService
func (mmCreateOrder *LomsServiceMock) CreateOrder(request lomsTypes.OrderCreateRequest) (op1 *lomsTypes.OrderCreateResponse, err error) {
...
type LomsServiceMockStocksInfoParams struct {
	request lomsTypes.StocksInfoRequest
}
...
type LomsServiceMockStocksInfoResults struct {
	sp1 *lomsTypes.StocksInfoResponse
	err error
}
...
func (mmStocksInfo *mLomsServiceMockStocksInfo) Expect(request lomsTypes.StocksInfoRequest) *mLomsServiceMockStocksInfo {
...
func (mmStocksInfo *mLomsServiceMockStocksInfo) ExpectRequestParam1(request lomsTypes.StocksInfoRequest) *mLomsServiceMockStocksInfo {
	if mmStocksInfo.mock.funcStocksInfo != nil {
		mmStocksInfo.mock.t.Fatalf("LomsServiceMock.StocksInfo mock is already set by Set")
	}
...
func (mmStocksInfo *mLomsServiceMockStocksInfo) Inspect(f func(request lomsTypes.StocksInfoRequest)) *mLomsServiceMockStocksInfo {
...
func (mmStocksInfo *mLomsServiceMockStocksInfo) Return(sp1 *lomsTypes.StocksInfoResponse, err error) *LomsServiceMock {
	if mmStocksInfo.mock.funcStocksInfo != nil {
		mmStocksInfo.mock.t.Fatalf("LomsServiceMock.StocksInfo mock is already set by Set")
	}
...
func (mmStocksInfo *mLomsServiceMockStocksInfo) Set(f func(request lomsTypes.StocksInfoRequest) (sp1 *lomsTypes.StocksInfoResponse, err error)) *LomsServiceMock {
	if mmStocksInfo.defaultExpectation != nil {
...
// Then helper
func (mmStocksInfo *mLomsServiceMockStocksInfo) When(request lomsTypes.StocksInfoRequest) *LomsServiceMockStocksInfoExpectation {
	if mmStocksInfo.mock.funcStocksInfo != nil {
		mmStocksInfo.mock.t.Fatalf("LomsServiceMock.StocksInfo mock is already set by Set")
	}
...
func (e *LomsServiceMockStocksInfoExpectation) Then(sp1 *lomsTypes.StocksInfoResponse, err error) *LomsServiceMock {
...
// StocksInfo implements mm_add_item.LomsService
func (mmStocksInfo *LomsServiceMock) StocksInfo(request lomsTypes.StocksInfoRequest) (sp1 *lomsTypes.StocksInfoResponse, err error) {
